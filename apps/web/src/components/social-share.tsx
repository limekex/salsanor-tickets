...
// WhatsApp and Telegram icons (not in lucide-react)
...
export function SocialShare({ url, title, description, className }: SocialShareProps) {
    ...
    // Build share links (will show placeholder URLs until origin is set)
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
                ...
                <DropdownMenuItem onClick={handleCopy} className="flex items-center gap-2 cursor-pointer">
                    {copied ? (
                        <>
                            <Check className="h-4 w-4 text-rn-success" />
                            Copied!
                        </>
                    ) : (
                        <>
