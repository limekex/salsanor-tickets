        ...
        return (
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Global Admin Dashboard</h2>
                        <p className="text-muted-foreground mt-1">Select an organization to manage their courses and events</p>
                    </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Payment providers & global settings</p>
                            <Button asChild className="mt-4 w-full" variant="outline">
