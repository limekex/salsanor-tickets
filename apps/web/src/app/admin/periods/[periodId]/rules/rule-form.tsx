...
import { createDiscountRule, updateDiscountRule } from '@/app/actions/discounts'
...
export function RuleForm({ periodId, existingRule }: Props) {
    ...
    const tiers = existingRule?.config?.tiers ?? undefined
    ...
    const form = useForm<DiscountRuleFormData>({
        ...
        defaultValues: {
            ...
            ruleType: (existingRule?.ruleType as any) ?? 'MEMBERSHIP_PERCENT',
                        ...
                        <div className="space-y-4">
                            ...
                            <FormItem>
                                ...
                                <Input
                                    ...
                                    defaultValue={tiers ? JSON.stringify(tiers) : ''}
                                    onChange={(e) => {
                                        try {
