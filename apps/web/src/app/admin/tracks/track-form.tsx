...
import { createCourseTrack } from '@/app/actions/tracks'
import { useRouter } from 'next/navigation'
import { useTransition } from 'react'
import { Card, CardContent } from '@/components/ui/card'

export function TrackForm({ periodId }: { periodId: string }) {
    ...
    async function onSubmit(data: CourseTrackFormValues) {
        ...
        formData.append('periodId', data.periodId as string)
        ...
        startTransition(async () => {
            const result = await createCourseTrack(null, formData)
            if (result?.error) {
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Follow Cap</FormLabel>
                                        <FormControl>
                                            <Input type="number" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                ...
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            ...
                                            {/* Actually usually mix, but enum says LEADER/FOLLOWER/ANY. 
                              Wait, enum TrackRole { LEADER, FOLLOWER, ANY }. 
                              Schema says rolePolicy is TrackRole. 
                              Usually this means "What roles are allowed?". 
                              But if split capacity is used, allow both?
                              The spec schema says `rolePolicy TrackRole @default(ANY)`.
                              Let's assume ANY allows both.
                          */}
                                        </SelectContent>
                                    </Select>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Price (Ore/Cents)</FormLabel>
                                        <FormControl>
                                            <Input type="number" {...field} />
                                        </FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Pair Price (Ore)</FormLabel>
                                        <FormControl>
                                            <Input type="number" {...field} />
                                        </FormControl>
                                        <FormMessage />
